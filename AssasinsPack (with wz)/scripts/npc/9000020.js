...
/* Spinel Multi Teleporter of HosuaMS
*/
...
function action(mode, type, selection) {
			...
			status--;
               ...
               if (status == 0) {
                        cm.sendNext("Hey I'm PCMaple's All-in-one Teleport Manager!");                  
                }
               if (status == 1) {
                   cm.sendSimple("#L0#World Tour#l\r\n#L1#Open Maple Wep Shop#l\r\n#L2#Nothing#l");
               }
               else if (status == 2) {
                   if (selection == 0) {
