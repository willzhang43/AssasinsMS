...
function action(mode, type, selection) {
	...
	if (status == 0 && mode == 1) {
		...
		if (selectedType == 0){ //warrior glove
			...
			var gloves = new Array(1082103,1082104,1082105,1082114,1082115,1082116,1082117);
			var suffix = new Array (" - Warrior Lv. 70"," - Warrior Lv. 70"," - Warrior Lv. 70",
				" - Warrior Lv. 80"," - Warrior Lv. 80"," - Warrior Lv. 80"," - Warrior Lv. 80");
			for (var i = 0; i < gloves.length; i++){
				selStr += "\r\n#L" + i + "##z" + gloves[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
		}
		else if (selectedType == 1){ //bowman glove
			var selStr = "Bowman glove? Okay, then which one?#b";
			var gloves = new Array(1082106,1082107,1082108,1082109,1082110,1082111,1082112);
			var suffix = new Array (" - Bowman Lv. 70"," - Bowman Lv. 70"," - Bowman Lv. 70",
			...
			var gloves = new Array(1082098,1082099,1082100,1082121,1082122,1082123);
			var suffix = new Array (" - Magician Lv. 70"," - Magician Lv. 70"," - Magician Lv. 70",
			...
			var gloves = new Array (1082095,1082096,1082097,1082118,1082119,1082120);
			var suffix = new Array (" - Thief Lv. 70"," - Thief Lv. 70"," - Thief Lv. 70",
		...
		if (cm.getMeso() < cost)
			...
			if (!complete) 
				...
				if (cm.canHold(item)) {
					...
					cm.sendOk("Please make room in your inventory for the item.");
				}
			}
		cm.dispose();
	}
