...
function action(mode, type, selection) {
	...
	if (status == 0 && mode == 1) {
		...
		if (selectedType == 0) { //What's a stim?
			...
			var items = new Array(1082007,1082008,1082023,1082009);
			var suffix = new Array (" - Warrior Lv. 30"," - Warrior Lv. 35"," - Warrior Lv. 40"," - Warrior Lv. 50");
			...
			var items = new Array(1082048,1082068,1082071,1082084);
			var suffix = new Array (" - Bowman Lv. 30"," - Bowman Lv. 35"," - Bowman Lv. 40"," - Bowman Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array(1082051,1082054,1082062,1082081);
			var suffix = new Array (" - Magician Lv. 30"," - Magician Lv. 35"," - Magician Lv. 40"," - Magician Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array(1082042,1082046,1082075,1082065);
			var suffix = new Array (" - Thief Lv. 30"," - Thief Lv. 35"," - Thief Lv. 40"," - Thief Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array(1082005,1082006,1082035,1082036,1082024,1082025,1082010,1082011);
			var suffix = new Array (" - Warrior Lv. 30"," - Warrior Lv. 30"," - Warrior Lv. 35"," - Warrior Lv. 35",
				" - Warrior Lv. 40"," - Warrior Lv. 40"," - Warrior Lv. 50"," - Warrior Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array (1082049,1082050,1082069,1082070,1082072,1082073,1082085,1082083);
			var suffix = new Array (" - Bowman Lv. 30"," - Bowman Lv. 30"," - Bowman Lv. 35"," - Bowman Lv. 35"," - Bowman Lv. 40"," - Bowman Lv. 40"," - Bowman Lv. 50"," - Bowman Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array(1082052,1082053,1082055,1082056,1082063,1082064,1082082,1082080);
			var suffix = new Array (" - Magician Lv. 30"," - Magician Lv. 30"," - Magician Lv. 35"," - Magician Lv. 35",
				" - Magician Lv. 40"," - Magician Lv. 40"," - Magician Lv. 50"," - Magician Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var items = new Array(1082043,1082044,1082047,1082045,1082076,1082074,1082067,1082066);
			var suffix = new Array (" - Thief Lv. 30"," - Thief Lv. 30"," - Thief Lv. 35"," - Thief Lv. 35"," - Thief Lv. 40",
				" - Thief Lv. 40"," - Thief Lv. 50"," - Thief Lv. 50");
			for (var i = 0; i < items.length; i++){
				selStr += "\r\n#L" + i + "##z" + items[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
