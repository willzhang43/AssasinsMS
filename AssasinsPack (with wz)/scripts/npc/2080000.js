...
function action(mode, type, selection) {		
	...
	if (status == 0 && mode == 1) {
		...
		if (selectedType == 0) { //What's a stim?
			...
			var suffix = new Array (" - Lv. 110 One-Handed Sword"," - Lv. 110 One-Handed Axe"," - Lv. 110 One-Handed BW"," - Lv. 110 Two-Handed Sword"," - Lv. 110 Two-Handed Axe"," - Lv. 110 Two-Handed BW",
				" - Lv. 110 Spear"," - Lv. 110 Polearm");
			...
			var suffix = new Array (" - Lv. 110 Bow"," - Lv. 110 Crossbow");
			for (var i = 0; i < weapon.length; i++){
				selStr += "\r\n#L" + i + "##z" + weapon[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var suffix = new Array (" - Lv. 108 Wand"," - Lv. 110 Staff");
			for (var i = 0; i < weapon.length; i++){
				selStr += "\r\n#L" + i + "##z" + weapon[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
			...
			var suffix = new Array (" - Lv. 110 STR Dagger"," - Lv. 110 LUK Dagger"," - Lv. 110 Claw");
			for (var i = 0; i < weapon.length; i++){
				selStr += "\r\n#L" + i + "##z" + weapon[i] + "##k" + suffix[i] + "#l#b";
			}
			cm.sendSimple(selStr);
