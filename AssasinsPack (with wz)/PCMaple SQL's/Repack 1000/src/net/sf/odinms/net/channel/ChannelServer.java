...
public class ChannelServer implements Runnable, ChannelServerMBean {
	...
	private String serverMessage = "Welcome to Xtinct MapleStory - The eXtinctions of the once alive.";
	private int expRate;
			...
			synchronized (cwi) {
				...
				synchronized (wci) {
					...
					try {
						...
						dropUndroppables = Boolean.parseBoolean(
								props.getProperty("net.sf.odinms.world.alldrop", "false"));
						moreThanOne = Boolean.parseBoolean(
								props.getProperty("net.sf.odinms.world.morethanone", "false"));
	...
	public void shutdown(int time) {
		broadcastPacket(MaplePacketCreator.serverNotice(0, "The world will shut down in " + (time / 60000) +	" minute, please log off safely."));
